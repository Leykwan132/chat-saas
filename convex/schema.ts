...
export default defineSchema({
  ...
  whiteLabelPartnerOrganizationPlans: defineTable({
    ...
    pendingMaxAgents: v.optional(v.number()),
    pendingMaxAgentsEffectiveAt: v.optional(v.number()),
    pendingMonthlyCredits: v.optional(v.number()),
    pendingMonthlyCreditsEffectiveAt: v.optional(v.number()),
