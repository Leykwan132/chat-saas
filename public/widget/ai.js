(function () {
  ...
  root.innerHTML = [
    ...
    ".close{display:flex;align-items:center;justify-content:center;width:32px;height:32px;border:0;border-radius:999px;background:transparent;color:var(--muted);cursor:pointer;transition:background .2s,color .2s}.close svg{width:16px;height:16px}.close.reset svg{width:24px;height:24px}.close:hover{background:var(--avatar-bg);color:var(--panel-text)}",
