(function () {
  ...
  function loadRuntime(name, config) {
    ...
    runtime.async = true;
    ["data-kilobot-widget", "data-kilobot-api", "data-kilobot-exclude-path-prefix"].forEach(function (attribute) {
  ...
  fetch(configUrl())
    ...
    .then(function (config) {
      loadRuntime(config.mode === "traditional" ? "traditional" : "ai", config);
    })
    .catch(function () {
      loadRuntime("ai");
    });
