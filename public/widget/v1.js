(function () {
  ...
  root.innerHTML = [
    ...
    ".ready{opacity:1;translate:0 0;visibility:visible;transition-delay:0s}.wrap,.wrap *{box-sizing:border-box}",
    ...
    ".avatar{display:flex;align-items:center;justify-content:center;width:32px;height:32px;border:1px solid var(--panel-border);border-radius:999px;background:var(--avatar-bg);color:var(--avatar-text);overflow:hidden;flex:0 0 auto}.avatar img{display:block;width:100%;height:100%;border-radius:999px;object-fit:cover}.avatar img.fallbackIcon{padding:0;object-fit:contain}.launcher .avatar{width:40px;height:40px;border:0;background:#000;color:#fff}",
