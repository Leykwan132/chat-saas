(function () {
  ...
  function mount(config, publicKey) {
    ...
    root.innerHTML = [
      ...
      ".pill{display:flex;max-width:min(calc(100vw - 36px),320px);align-items:center;gap:8px;border:2px solid var(--main-color);border-radius:999px;background:#fff;color:var(--main-color);padding:7px 14px 7px 8px;text-decoration:none;transition:transform .2s ease}",
