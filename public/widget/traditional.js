(function () {
  ...
  function mount(config, publicKey) {
    ...
    root.innerHTML = [
      ...
      ".pill{display:flex;max-width:min(calc(100vw - 36px),320px);align-items:center;gap:8px;border:4px solid var(--main-color);border-radius:999px;background:#fff;color:var(--main-color);padding:7px 14px 7px 8px;text-decoration:none;transition:transform .2s ease}",
      ".pill:hover{transform:translateY(-2px)}.pill:focus-visible{outline:3px solid #111827;outline-offset:3px}",
      ".icon{display:flex;width:30px;height:30px;flex:0 0 auto;align-items:center;justify-content:center;border-radius:999px;overflow:hidden}.icon svg,.icon img{display:block;width:100%;height:100%;object-fit:contain}",
      ".label{overflow:hidden;color:#000;text-overflow:ellipsis;white-space:nowrap;font-family:'Google Sans Flex',sans-serif;font-size:14px;font-weight:400;line-height:1.2}.brand{align-self:center;color:#6b7280;font-size:10px;line-height:1.2}.brand a{color:inherit;text-decoration:none}.brand a:hover{text-decoration:underline}",
