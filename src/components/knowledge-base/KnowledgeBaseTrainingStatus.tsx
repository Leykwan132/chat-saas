...
export function KnowledgeBaseTrainingStatus({ trainingItemCount, onTest }: KnowledgeBaseTrainingStatusProps) {
  if (trainingItemCount > 0) {
    return (
      <button type="button" aria-label="Test your agent" onClick={onTest} className="inline-flex items-center gap-2 rounded-full bg-muted px-4 py-2 text-sm font-medium text-foreground transition-colors hover:bg-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">
