  ...
  return (
    <div
      className={cn(
        ...
        mobile ? 'min-h-[620px] place-items-center' : 'items-start pt-6',
      )}
    >
      <div
        className={cn(
          'mx-auto',
          mobile ? 'shrink-0' : 'w-full max-w-[920px]',
        )}
        style={
          mobile ? { width: 'min(22rem, calc(100vw - 4rem))' } : undefined
        }
      >
        <AspectRatio
          ratio={mobile ? 9 / 16 : 16 / 10}
          className={cn(
