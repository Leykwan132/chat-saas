    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          variant="outline"
          size="icon"
          className="cursor-pointer rounded-xl border-black bg-black text-white shadow-lg hover:bg-black hover:text-white active:bg-black active:text-white aria-expanded:bg-black aria-expanded:text-white focus-visible:border-black focus-visible:ring-0"
