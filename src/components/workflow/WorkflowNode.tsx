    ...
    <div className={cn('group relative flex flex-col items-center', nodeFrameClassName)}>
      ...
      <div
        className={cn(
          ...
          (data.description || hasBookingServices) && describedNodeWidthClassName,
        )}
      >
        <div className={cn(
