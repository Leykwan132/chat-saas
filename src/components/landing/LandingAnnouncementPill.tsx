    ...
    >
      ...
      <span className="relative z-10 min-w-0 truncate">
        ...
        <img
          src={logoUrl}
          alt={logoAlt}
          className="mr-1 inline-block size-3 shrink-0 align-[-0.1em] object-contain sm:mr-1.5 sm:size-3"
        />
        {afterLogo}
      </span>
