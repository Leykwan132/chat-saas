    ...
    style={
      {
        ...
        "--media-button-icon-height": "0.75rem",
        "--media-button-icon-width": "0.75rem",
...
export const AudioPlayerControlBar = ({
  ...
  <MediaControlBar data-slot="audio-player-control-bar" {...props}>
    <ButtonGroup orientation="horizontal" className="h-6 items-center">{children}</ButtonGroup>
  </MediaControlBar>
);
...
export const AudioPlayerPlayButton = ({
  ...
  <Button asChild size="icon-xs" variant="outline" className="h-6">
    <MediaPlayButton
...
export const AudioPlayerTimeDisplay = ({
  ...
  <ButtonGroupText asChild className={cn("h-6 text-[11px] px-1.5 bg-transparent", className)}>
    <MediaTimeDisplay
...
export const AudioPlayerTimeRange = ({
  ...
  <ButtonGroupText asChild className={cn("h-6 px-1.5 bg-transparent", className)}>
    <MediaTimeRange
      className="h-2 w-16 min-w-8 flex-1"
...
export const AudioPlayerMuteButton = ({
  ...
  <ButtonGroupText asChild className={cn("h-6 px-1.5 bg-transparent [&_svg]:size-3", className)}>
    <MediaMuteButton
...
export const AudioPlayerVolumeRange = ({
  ...
  <ButtonGroupText
    data-slot="audio-player-volume-range-wrapper"
    className={cn("h-6 px-2.5 bg-transparent flex items-center justify-center", className)}
  >
    <MediaVolumeRange
      className="h-2 w-12 min-w-8"
