...
- [ ] **Step 1: Write failing measurement-extraction and persistence tests**
...
- [ ] **Step 3: Add the minimal measurement data flow**
...
- [ ] **Step 5: Commit the measured Cleanup data flow**
...
- [ ] **Step 1: Write the failing expanded-node layout regression**
...
- [ ] **Step 3: Use effective measured dimensions in Dagre and collision resolution**
...
- [ ] **Step 4: Run focused layout and routing tests to verify GREEN**
