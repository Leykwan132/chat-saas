...
- [x] **Step 1: Add failing exact-data assertions**
...
- [x] **Step 3: Add the typed approved mapping**
...
- [x] **Step 1: Add failing rendered-behavior assertions**
...
- [x] **Step 3: Render the lightweight section**
...
- [x] **Step 1: Run branch-level gates**
...
- [x] **Step 2: Record and commit the verified state**
