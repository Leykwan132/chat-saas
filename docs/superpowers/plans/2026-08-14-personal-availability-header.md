...
- [ ] **Step 1: Extend the failing personal route regression test**
...
- [ ] **Step 3: Localize time-off action state and button**
...
- [ ] **Step 4: Render the personal-only Availability title block**
