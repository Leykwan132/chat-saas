...
Focused pricing-catalog tests will assert the standalone label, analytics-group ordering, unchanged plan availability, dedicated hover copy, and Advanced Analytics' two-item hover list. No Convex code generation or migration is required because no backend interface changes.
