...
The existing LandingHero remains the landing page's single, prominent H1. Its wording names the product category and outcomes in customer language. The supporting description communicates the product benefit and removes setup friction.
